...
pegawai.jabatan,
pegawai.gelar_depan,
pegawai.gelar_depan_akademik,
pegawai.gelar_belakang,
pegawai.almt_sekarang,
pegawai.no_hp,
pegawai.email,
pegawai.file
FROM
pegawai
        ...
        WHERE pegawai.id_pegawai = '$_GET[id]' ";
...
{ 
  ...
  if(($_FILES["file"]["type"] == "image/gif") || ($_FILES["file"]["type"] == "image/jpeg") || ($_FILES["file"]["type"] == "image/png") || ($_FILES["file"]["type"] == "image/pjpeg")){
           ...
           $query          = mysql_query("UPDATE inspeksi SET id_pegawai='$_GET[id]' , id_user='2', password='$password' , nm_pegawai='$nm_pegawai' , tmpt_lahir='$tmpt_lahir' , date_tgl_lahir='$ubahtgl' , jns_kelamin='$jns_kelamin'  , agama='$agama' , status='$status' , jabatan='$jabatan' , gelar_depan='$gelar_depan' , gelar_depan_akademik='$gelar_depan_akademik' , gelar_belakang='$gelar_belakang' , almt_sekarang='$almt_sekarang' , no_hp='$no_hp' , email='$email' ,  file='$jeneng')" ) or die(mysql_error());
