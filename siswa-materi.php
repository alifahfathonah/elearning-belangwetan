...
checkUserAuth();
checkUserRole(array(0, 10));

// TEMPLATE CONTROL
$ui_register_page = 'siswa-materi';

// LOAD HEADER
loadAssetsHead('Materi Pelajaran');
    ...
    <div class="uk-grid uk-margin-large-top" data-uk-grid-margin data-uk-grid-match>
      ...
      <div class="uk-width-medium-5-6 tm-article-side">
        <article class="uk-article">		
          ...
          <h1 class="uk-article-title">Materi dari Guru <span class="uk-text-large">
					...
					<table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
						<thead>
							<tr>
								...
								<th><h3 class="uk-text-center">Lihat Materi</h3></th>
							...
							while ($data=mysql_fetch_array($hasil)) { $no++;
							  ...
							  <tr>
								...
								<td><div class="uk-text-center">
								  <a href="siswa-lihatmateri?id=<?php echo $data['kd_mengajar']?>&&kd_kelas=<?php echo $_SESSION['kd_kelas']?>" title="Lihat Materi" data-uk-tooltip="{pos:'top-left'}" class="btn btn-success">Lihat Materi</i></a>
