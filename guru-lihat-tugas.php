...
// LOAD HEADER
loadAssetsHead('Master Data Tugas dari Guru');
...
FROM
tugas
INNER JOIN guru ON tugas.nip = guru.nip
INNER JOIN kelas ON tugas.kd_kelas = kelas.kd_kelas
...
$lihat=mysql_query($nip);
						...
						while ($data=mysql_fetch_array($lihat)) { $no++;
						    ...
						    ?>
							  ...
							  <tr>
								...
								<td><div class="uk-text-center"><?php echo $data['keterangan']?></div></td>
								...
								<td><div class="uk-text-center">
								  <a href="guru-tugas.update?id=<?php echo $data['kd_tugas']?>" title="Sunting" data-uk-tooltip="{pos:'top-left'}" class="uk-button uk-button-small"><i class="uk-icon-pencil"></i></a>
								  <a href="guru-tugas.hapus?id=<?php echo $data['kd_tugas']?>" onclick="return confirm('Apakah anda yakin akan menghapus data Tugas: <?php echo $row[1] ?> ini?')" title="Hapus" data-uk-tooltip="{pos:'top-left'}" class="uk-button uk-button-small uk-button-danger"><i class="uk-icon-remove"></i></a>
								</div>
								</td>
								<?php } ?>						
							  </tr>
					...
					<br><br><br>
				<center><a href="./lihat-tugas-siswa" class="btn btn-success" type="button" title="Tambah Data Materi"> Lihat Tugas Siswa</a></center>
</br>
				<center><a href="./guru-tugas.tambah?upload=<?php echo $cek_guru['nip']; ?>" class="btn btn-success btn-lg" type="button" title="Tambah Data Materi"><i class="uk-icon-plus"></i> Beri Tugas</a></center>
