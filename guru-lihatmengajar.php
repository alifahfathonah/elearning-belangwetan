...
// TEMPLATE CONTROL
$ui_register_page     = 'guru-mengajar';
$ui_register_assets   = array('datepicker');

// LOAD HEADER
loadAssetsHead('Lihat Data Mengajar Guru');
  ...
  <div class="uk-container uk-container-center">
    ...
    <div class="uk-grid uk-margin-large-top" data-uk-grid-margin data-uk-grid-match>
      ...
      { Master Data }</span></h1>
          <?php  }?>
          <br>
         <a href="./guru-mengajar" class="uk-button uk-button-success" type="button" title="Kembali ke Data Guru Mengajar">Kembali</a>
          <?php if (isset($_SESSION['pengguna'])) { ?>
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            ...
            <tr>
                ...
                <td><div class="uk-text-center">
                  <a href="guru-lihatsiswa?id=<?php echo $data['kd_kelas']?>" title="Sunting" data-uk-tooltip="{pos:'top-left'}" class="uk-button uk-button-success">Lihat Siswa</i></a>
