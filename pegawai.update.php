...
// LOAD HEADER
loadAssetsHead('Update Data Pegawai');
...
{ 
  ...
  if(($_FILES["file"]["type"] == "image/gif") || ($_FILES["file"]["type"] == "image/jpeg") || ($_FILES["file"]["type"] == "image/png") || ($_FILES["file"]["type"] == "image/pjpeg")){
           ...
           $query=mysql_query("UPDATE pegawai SET id_pegawai='$id_pegawai' , id_user='2', password='$password' , nm_pegawai='$nm_pegawai' , tmpt_lahir='$tmpt_lahir' , date_tgl_lahir='$ubahtgl' , jns_kelamin='$jns_kelamin'  , agama='$agama' , status='$status' , jabatan='$jabatan' , gelar_depan='$gelar_depan' , gelar_depan_akademik='$gelar_depan_akademik' , gelar_belakang='$gelar_belakang' , almt_sekarang='$almt_sekarang' , no_hp='$no_hp' , email='$email' ,  file='$jeneng' WHERE id_pegawai='$_GET[id]'") or die(mysql_error());
    ...
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match>
      ...
      <div class="uk-width-medium-5-6 tm-article-side">
        <article class="uk-article">
          ...
          <h1 class="uk-article-title">PEGAWAI<span class="uk-text-large">{ Update Pegawai }</span></h1>
          <br>
            ...
            <div class="uk-width-medium-1-1">
              <form class="uk-form uk-form-stacked" method="post" enctype="multipart/form-data">
                ...
                <tr>
                  ...
                  <td class="reg-input"><div class="uk-form-controls"><input type="number" name="id_pegawai" id="id_pegawai" value = "<?php echo $row[0];?>"  class="uk-width-1-4" autofocus  style="width:300px" placeholder="id_pegawai"  autofocus required></div>
                ...
                <tr>
                  ...
                  <td class="reg-input"><div class="uk-form-controls"><input type="text" name="nm_pegawai" id="nm_pegawai" value = "<?php echo $row[2];?>"  class="uk-width-1-4" autofocus style="width:300px" placeholder="Nama" autofocus required></div>
                ...
                <tr>
                  ...
                  <td class="reg-input"><div class="uk-form-controls"><input type="text" name="password" id="password" value = "<?php echo $row[3];?>"  class="uk-width-1-4" autofocus style="width:300px" placeholder="password"  autofocus required></div></div>
                ...
                <tr>
                  ...
                  <td class="reg-input">
                    <div class="uk-form-controls"><input type="date" name="date_tgl_lahir" id="date_tgl_lahir" value = "<?php echo date ("$row[5]",strtotime($row[5]));;?>" placeholder="Nama" class="uk-width-1-4" autofocus ></div>
                ...
                <tr>
                  ...
                  <td class="reg-input"><div class="uk-form-controls">
                     <input type="text" name="tmpt_lahir" id="tmpt_lahir" value = "<?php echo $row[tmpt_lahir];?>"  class="uk-width-1-4" autofocus placeholder="tmpt_lahir" style="width:300px" class="uk-width-1-5" autofocus required></div>
                ...
                <tr>
                  ...
                  <td class="reg-input"><div class="uk-form-controls"><input type="text" name="status" id="status" value = "<?php echo $row[status];?>"  class="uk-width-1-4" autofocus placeholder="Status" style="width:300px" autofocus required></div>
                 ...
                 <div class="uk-form-row">
                  ...
                  <td class="reg-input"><div class="uk-form-controls"><input type="text" name="jabatan" id="jabatan" value = "<?php echo $row[jabatan];?>"  class="uk-width-1-4" autofocusplaceholder="jabatan" style="width:300px" autofocus required></div>
                </td>
                </div>
                </tr>
                <tr>
                 <div class="uk-form-row">
                  ...
                  <td class="reg-input"><div class="uk-form-controls"><input type="text" name="gelar_depan" id="gelar_depan" value = "<?php echo $row[gelar_depan];?>"  class="uk-width-1-4" autofocusplaceholder="Gelar Depan" style="width:300px" autofocus></div>
                </td>
                </div>
                </tr>
                <tr>
                <div class="uk-form-row">
                  ...
                  <td class="reginput">
                  <div class="uk-form-controls"><input type="text" name="gelar_depan_akademik" id="gelar_depan_akademik" value = "<?php echo $row[gelar_depan_akademik];?>"  class="uk-width-1-4" autofocus placeholder="Gelar Depan Akademik" style="width:300px" autofocus></div>
                </td>
                </div>
                </tr>
                <tr>
                <div class="uk-form-row">
                  ...
                  <td class="reg-input"><div class="uk-form-controls"><input type="text" name="gelar_belakang" id="gelar_belakang" value = "<?php echo $row[gelar_belakang];?>"  class="uk-width-1-4" autofocus placeholder="Gelar Belakang" style="width:300px" autofocus></div>
                </td>
                </div>
                </tr>
                <tr>
                <div class="uk-form-row">
                  ...
                  <td class="reg-input"><div class="uk-form-controls"><input type="text" name="almt_sekarang" id="almt_sekarang" value = "<?php echo $row[almt_sekarang];?>"  class="uk-width-1-4" autofocus placeholder="Alamat Rumah sekarang" style="width:300px" autofocus required></div>
                </td>
                </div>
                </tr>
                <tr>
                <div class="uk-form-row">
                  ...
                  <td class="reg-input"><div class="uk-form-controls"><input type="text" name="no_hp" id="no_hp" value = "<?php echo $row[no_hp];?>"  class="uk-width-1-4" autofocus placeholder="No HP" style="width:300px" autofocus required></div>
                </td>
                </div>
                </tr>
                <tr>
                <div class="uk-form-row">
                  ...
                  <td class="reg-input">
                  <div class="uk-form-controls"><input type="email" name="email" id="email" value = "<?php echo $row[email];?>"  class="uk-width-1-4" autofocus placeholder="email" style="width:300px"  autofocus required></div>
                </td></div>
                </tr>
                <tr>
                ...
                <div class="uk-form-row">
                  ...
                  </td><td class="reg-input"><div class="uk-form-controls"><input type="file" name="file" id="file" value = "<?php echo $row[file];?>"  class="uk-width-1-4" autofocus placeholder="file"  autofocus required>
                  <img id="previewing" src="gallery/pegawai/<?php echo $row[file];?>"  />
                  </div>
                </td>
                ...
                <div class="uk-form-row">
                  <button type="submit" value="Simpan Data" name="pegawai_update" id="pegawai_update" class="uk-button uk-button-large uk-button-success" title="Simpan Data Guru" disabled><i class="uk-icon-paper-plane"></i> Simpan</button>
                </div>
              </form>
            </div>
          </div>
...
{
    $('#pegawai_update').prop('disabled', false);
  }
  else {
    $('#pegawai_update').prop('disabled', true);
  }
}
function progress(){
