...
// TEMPLATE CONTROL
$ui_register_page = 'guru-mengejar';
          ...
          <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
            <thead>
              <tr>
                ...
                <th><h3 class="uk-text-center">Siswa</h3></th>
                ...
                <th><h3 class="uk-text-center">Agama</h3></th>
...
FROM
siswa
INNER JOIN kelas ON siswa.kd_kelas = kelas.kd_kelas
WHERE kelas.kd_kelas='$_GET[id]'";
         ...
         $no=0;
           ...
           ?>
                ...
                <td><div class="uk-text-center"><?php echo $data['nis']?></div></td>
                <td><div class="uk-text-center"><?php echo $data['nm_siswa']?></div></td>
                <td><div class="uk-text-center"><?php echo $data['jns_kelamin']?></div></td>
                <td><div class="uk-text-center"><?php echo $data['kd_kelas']?></a></div></td>
                <td><div class="uk-text-center"><?php echo $data['email']?></div></td>
                <td><div class="uk-text-center"><?php echo $data['agama']?></div></td>
