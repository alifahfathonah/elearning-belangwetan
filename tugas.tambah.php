...
if (isset ($_POST["tugas_simpan"])) { 
  ...
  $valid=0; 
    ...
    $ekstensi     = $pisah[1];
$uniqueID= rand(1000,100000)."-".$fileName;
    ...
    if(!in_array($ekstensi,$extensiList))
    {
      ...
      echo "<META HTTP-EQUIV=\"REFRESH\" CONTENT=\"10;URL=tugas-guru.tambah.php\">";
      $valid= 1;
    }
    ...
    if($valid != 1)
    {
      ...
      VALUES (NULL, '$uniqueID', '$fileSize', '$judul_tugas', '$keterangan' , '$nip', '$kd_kelas', '$kd_mapel', sysdate(), '$fileType', '$konten')";
      ...
      if($data)
      {
        ...
        echo "<META HTTP-EQUIV=\"REFRESH\" CONTENT=\"0;URL=tugas-guru.php\">";
      } else 

      {
        echo "<script> alert('Data gagal diupload')</script>";
        echo "<META HTTP-EQUIV=\"REFRESH\" CONTENT=\"0;URL=tugas-guru.tambah.php\">";
      }
    ...
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match>
      ...
      <div class="uk-width-medium-5-6 tm-article-side">
        <article class="uk-article">
          ...
          <br>
          <a href="./tugas-guru" class="uk-button uk-button-primary uk-margin-bottom" type="button" title="Kembali ke Manajemen Tugas"><i class="uk-icon-angle-left"></i> Kembali</a>
          <!-- <hr class="uk-article-divider"> -->
