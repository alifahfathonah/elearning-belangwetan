...
// LOAD HEADER
loadAssetsHead('Master Data Guru Materi Pelajaran');
    ...
    <div class="uk-grid uk-margin-large-top" data-uk-grid-margin data-uk-grid-match>
      ...
      <div class="uk-width-medium-5-6 tm-article-side">
        <article class="uk-article">		
          ...
          <h1 class="uk-article-title">Data Materi Pelajaran <span class="uk-text-large">
...
<?php
          ...
          <td align='center'>
            ...
            <a href='guru-lihat-materi?id=$kd_mapel' class='uk-button'>Lihat Unggah</a>
            <a href='guru.materi.tambah?id=$kd_mapel' class='btn btn-success'>Unggah Materi</a>
           </form>";
           echo "</td>";
           echo "</tr>";
