				...
				<div id="tablewrapper">
					...
					<table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable">
						<thead>
							...
							<tbody>
						  <?php
						  $query="SELECT * FROM materi WHERE kd_materi";
						  ...
						  while ($data=mysql_fetch_array($hasil)) { $no++; 
							...
							$kelas=mysql_fetch_array(mysql_query("SELECT * from kelas INNER  materi on materi.kd_kelas = kelas.kd_kelas where kd_materi = '$kd_materi'"));
