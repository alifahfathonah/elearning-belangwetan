...
<body>
  ...
  <td>: <?php echo $_SESSION[nm_guru]?></td></tr>
      ...
      $nip = "SELECT * from guru where id_user ='$id_user'";
      $query=mysql_query($nip);

      $cekguru=mysql_fetch_array($query);
      $user=$cekguru['nip'];
    
      $sql="SELECT * from mengajar, mapel where mapel.kd_mapel = mengajar.kd_mapel and nip='$user'";
   ...
   echo "<table cellpadding='0' cellspacing='0' border='0' id='table' class='tinytable'>";
	 echo "<thead>
      ...
      while ($data = mysql_fetch_array($hasil)) {
          ...
          <td align='center'>
            <a href='guru-lihatmengajar?nip=$nip' class='uk-button uk-button-small'>Lihat Kelas</a>
           </form>";
           echo "</td>";
           echo "</tr>";
